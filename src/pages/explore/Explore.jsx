        ...
        <div className="searchResultsPage min-h-[700px] pt-[100px]">
            <div className="w-full max-w-[1200px] my-0 mx-auto pb-2 md:pb-4 px-5 relative">
                <div className="pageHeader flex justify-between mb-[25px] flex-col md:flex-row">
                    <div className="pageTitle text-sm md:text-lg lg:text-2xl text-white font-semibold mb-4">
                        {mediaType === "tv"
                            ? "Explore TV Shows"
                            : "Explore Movies"}
                    </div>
                    <div className="filters flex gap-[10px] flex-col md:flex-row z-[2] relative">
                        <Select
                            isMulti
                            name="genres"
                            value={genre}
                            ...
                            className="react-select-container w-full md:max-w-[500px] md:min-w-[250px] genresDD"
                        ...
                        <Select
                            ...
                            isClearable={true}
                            placeholder="Sort by"
                            className="react-select-container w-full md:w-[250px] shrink-0 sortbyDD"
                            classNamePrefix="react-select"
                        />
                    </div>
                </div>
