    ...
    const skeleton = () => {
        return (
            <div className="skItem w-[125px] sm:w-[20%] md:w-[17.7%] lg:w-[14.95%] xl:w-[12.5%] shrink-0">
                <div className="circle profileImg w-full aspect-[20/30] rounded-2xl mb-[15px] md:mb-[25px] skeleton relative overflow-hidden bg-gray-dark after:absolute after:inset-0 after:translate-x-[-100%]"></div>
                <div className="row w-full h-5 rounded-[10px] mb-[10px] skeleton relative overflow-hidden bg-gray-dark after:absolute after:inset-0 after:translate-x-[-100%]"></div>
                <div className="row2 w-2/4 h-5 rounded-[10px] my-0 skeleton relative overflow-hidden bg-gray-dark after:absolute after:inset-0 after:translate-x-[-100%]"></div>
            </div>
        );
    };
    return (
