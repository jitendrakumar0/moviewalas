...
const PersonCard = ({ data, fromSearch, mediaType, className }) => {
    ...
    return (
        <div
            className={`PersonCard cursor-pointer delay-75 duration-300 hover:scale-95 ${className}`}
        ...
        >
            <div className="posterBlock relative w-full aspect-[1/1.5] bg-cover bg-center mb-7 flex items-end justify-between p-2">
                <Img
                    src={
                        data?.profile_path
                            ? url.profile_sizes_w45 + data?.profile_path
                            : PosterFallback
                    }
                    srcSet={`${
                        data?.profile_path
                        ...
                        data?.profile_path
                            ? url.profile_sizes_w185 + data?.profile_path
                            : PosterFallback
                    } 400w`}
                    width={"196"}
                    height={"294"}
